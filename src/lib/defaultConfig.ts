...
export const DEFAULT_CONFIG: ScamConfig = {
  ...
  greek: {
    ...
    paymentWords: [
      ...
      'ανεξοφλητ', 'διοδιο', 'παραβαση', 'εισφορ', 'τελη',
      'αντιτιμο', 'χρεωση', 'συνδρομη', 'τελος', 'κοστος',
      'αποζημιωση', 'επιστροφη χρηματων',
    ],
    rewardWords: [
      'κερδισ', 'κερδη', 'νικητης', 'δωρο', 'prize', 'winner',
    ...
    brands: [
      ...
      { name: 'Courier / Delivery', keywords: ['fedex', 'dhl', 'ups', 'boxnow', 'speedex', 'acs courier', 'γενικη ταχυδρομικη'], domains: ['fedex.com', 'dhl.com', 'ups.com'] },
    ],
  },
}
